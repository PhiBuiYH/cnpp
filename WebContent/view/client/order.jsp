    ...
    <div class="container">
      <div class="row">
      	<div>
      		...
      		<strong>Các bước mua hàng trên Web Nông Sản: </strong>
      		<p>
			...
			<p>Cách thức thực hiện cực đơn giản, dễ dàng, và nhanh chóng và có đầy đủ hướng dẫn sẽ tiết kiệm thời gian mua hàng của khách hàng.</p>
      		...
      		<p>Ngoài mua hàng thông qua website, khách hàng cũng có thể đặt hàng các sản phẩm của <strong>Web Nông Sản</strong> qua Hotline: 0123456789</p>
