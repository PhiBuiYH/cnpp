...
<!--                <a href="index.jsp">
                ...
                <!-- img based logo -->
                <a href="${pageContext.request.contextPath}/"><img src="${url}/images/logo.png" alt="logo img" width="60%"></a> 
              </div>
              <!-- / logo  -->
              <!-- Shipping service -->
              <div class="aa-shipping-box">
                  ...
                  <a class="aa-shipping-boxsmall">
                      ...
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Hỗ trợ: 0123456789</div>
                          <div class="">Tư vấn nhiệt tình</div>
                      </span>
                  ...
                  <a class="aa-shipping-boxsmall">
                      <span class="aa-shipping-boxsmall-icon fas fa-shipping-fast"></span>
                      <span class="aa-shipping-box-text">
                          <div class="aa-shipping-title">Giao hàng nhanh chóng</div>
