            ...
            <div class="row">
              ...
              <div class="col-md-7 no-padding">
                <div class="aa-promo-right">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/hat_sen.jpg" alt="img">                      
                      <div class="aa-prom-content">
                  ...
                  <div class="aa-single-promo-right">
                    <div class="aa-promo-banner">                      
                      <img src="${url}/images/sup_lo.jpg" alt="img">                      
                      <div class="aa-prom-content">
                        <span>Sản phẩm độc quyền</span>
                        <h4>Súp Lơ Tím Cực Bổ Dưỡng</h4>                        
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="aa-support-area">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <P>Chúng tôi đã áp dụng gói miễn phí vận chuyển cho đơn hàng trên 200.000VNĐ.</P>
              </div>
            </div>
            <!-- single support -->
            <div class="col-md-4 col-sm-4 col-xs-12">
          ...
          <div class="aa-testimonial-area">
            <ul class="aa-testimonial-slider">
              ...
              <li>
                ...
                <img class="aa-testimonial-img" src="${url}/images/phi.jpg" alt="avatar 1">
              ...
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/tin.jpg" alt="avatar 2">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
              ...
              <li>
                <div class="aa-testimonial-single">
                <img class="aa-testimonial-img" src="${url}/images/cuong.jpg" alt="avatar 3">
                  <span class="fa fa-quote-left aa-testimonial-quote"></span>
                  <p>Rau ở đây tươi lắm . Dịch vụ ở đây rất là tốt!</p>
                  <div class="aa-testimonial-info">
                    <p>Tấn Cường</p>
                    <span>Sinh viên</span>
                  </div>
